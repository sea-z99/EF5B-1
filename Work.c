...
void Tail_Stop_Check_Input(void)
{
	...
	if(Back_Status==0&&Tail_Status==0)//全低
	{
	...
	else if(Tail_Status==1&&Back_Status==0&&CB_Status==1)//侧标
	{
	...
	else if(Tail_Status==0&&Back_Status==1)//制动
	{
	...
	else if(Tail_Status==1&&Back_Status==1)//位置制动
	{
